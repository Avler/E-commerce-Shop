    ...
    return(
       ...
       <form onSubmit={handleSubmit}>
            <div className="form-cont">
                ...
                <input name="name" placeholder="Name" className="form-input" onChange={handleChange}/>
                <input name="email" placeholder="E-mail" className="form-input" onChange={handleChange}/>
                <input name="password" type="password" placeholder="Password"  className="form-input" onChange={handleChange}/>
                <div className="btn-cont">
                    <button className="user-panel-btn" onClick={showlogin}>Back to Login</button>

        ...
        <form className="add-item" onSubmit={formik.handleSubmit}>
          <div className="add-item-element">
            ...
            >
              ...
              <option value="Man" className="select-option">
                {" "}
                Man
              </option>
              <option value="Woman" className="select-option">
                Woman
              </option>
              <option value="Kids" className="select-option">
                Kids
              </option>
            </select>
          </div>
          ...
          <div className="add-item-element">
            <h2 className="add-item-title">Price</h2>
            <input
              type="text"
              className="form-input"
              name="product_price"
